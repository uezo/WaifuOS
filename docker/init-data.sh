...
mkdir -p "$DATA_PATH/aiavatar/recorded_voices"
mkdir -p "$DATA_PATH/aiavatar/waifus"
mkdir -p "$DATA_PATH/speech_gateway/cache"
mkdir -p "$DATA_PATH/sbv2-api-lite/model"
mkdir -p "$DATA_PATH/nginx/cert"
mkdir -p "$DATA_PATH/nginx/conf.d"
mkdir -p "$DATA_PATH/nginx/html"
...
# Copy initial data
cp ../server/aiavatar/system_prompt_base.md "$DATA_PATH/aiavatar"
cp ../server/aiavatar/default_icon.png "$DATA_PATH/aiavatar"
